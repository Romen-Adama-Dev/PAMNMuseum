...
fun BottomCard(transition: Transition<Boolean>, modifier: Modifier = Modifier) {
    ...
    Box(
        modifier = modifier
            ...
            .background(colorLogo.copy(alpha = 0.9f), RoundedCornerShape(24.dp))
    ){
        CardContent()
    }
}
...
fun CardContent() {
    ...
    Row(Modifier.padding(16.dp)) {
        Column {
            ...
            Text(
                text = "This is your ticket to the activity:",
                style = MaterialTheme.typography.subtitle2,
                color = Color.LightGray
            )
            Image(
                painter = painterResource(id = R.drawable.qr_example_white),
